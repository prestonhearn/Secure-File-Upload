...
## Security
[![Secure CI Pipeline](https://github.com/prestonhearn/Secure-File-Upload/actions/workflows/ci-workflow.yaml/badge.svg)](https://github.com/prestonhearn/Secure-File-Upload/actions/workflows/ci-workflow.yaml)
